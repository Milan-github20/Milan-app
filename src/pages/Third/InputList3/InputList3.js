...
import InputEdit3 from "../InputEdit3/InputEdit3";
import InputField3 from "../InputField3/InputField3";
import styles from "./InputList3.module.css";

const InputList = () => {
  const [fields, setFields] = useState(getInitalField(), []);

  function getInitalField() {
    const temp = localStorage.getItem("fields3");
  ...
  useEffect(() => {
    ...
    localStorage.setItem("fields3", temp);
  }, [fields]);
